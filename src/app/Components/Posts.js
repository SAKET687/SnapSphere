    ...
    const handleLike = async (postId) => {
        try {
            ...
            if (selectedPost.liked) {
                updatedLikes = selectedPost.no_likes - 1;
            }
            else {
                updatedLikes = selectedPost.no_likes + 1;
            }
                    ...
                    <div className='pro-info-main'>
                        <div className="left">
                            ...
                            <div className="pro-img-prev">
                                <Image alt="product-preview" src={`https://dytpynmiajyukcncmcrf.supabase.co/storage/v1/object/public/snapsphere_images/public/${selectedPost.image}`} width={200} height={300} />
                            </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button onClick={() => handleLike(selectedPost.post_id)}>
